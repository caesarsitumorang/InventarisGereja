...
$halaman = isset($_GET['page_pimpinan']) ? $_GET['page_pimpinan'] : '';
...
<body>
    <header class="top-bar">
        ...
        <nav>
            <ul class="nav-list">
                <li class="nav-item">
                    <a href="index_pimpinan.php" class="nav-link <?php echo empty($halaman) ? 'active' : ''; ?>">
                        <i class="fas fa-dashboard"></i> Dashboard
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index_pimpinan.php?page_pimpinan=data_akun/data_akun" 
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" id="inventarisDropdownMenu" style="max-height: 300px; overflow-y: auto;">
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/paroki/data_inventaris_paroki') ? 'active' : ''; ?>" 
                           href="index_pimpinan.php?page_pimpinan=data_inventaris/paroki/data_inventaris_paroki">
                           Paroki
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/fidelis/data_inventaris_fidelis') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/fidelis/data_inventaris_fidelis">
                        Stasi St. Fidelis
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/yohanes/data_inventaris_yohanes') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/yohanes/data_inventaris_yohanes">
                        ...
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/agustinus/data_inventaris_agustinus">
                        Stasi St. Agustinus 
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/benediktus/data_inventaris_benediktus') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/benediktus/data_inventaris_benediktus">
                        Stasi St. Benediktus 
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/paulus_inti/data_inventaris_paulus_inti') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/paulus_inti/data_inventaris_paulus_inti">
                        Stasi St. Paulus Inti
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/st_fransiskus_asisi') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/fransiskus/data_inventaris_fransiskus">
                        Stasi St. Fransiskus Asisi 
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/st_paulus_empang') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/paulus_empang/data_inventaris_paulus_empang">
                        Stasi St. Paulus Empang
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/sta_maria_karmel') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/maria/data_inventaris_maria">
                        Stasi Sta. Maria Bunda Karmel 
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/sta_elisabet') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/elisabet/data_inventaris_elisabet">
                        Stasi Sta. Elisabet
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/st_petrus') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/petrus/data_inventaris_petrus">
                        Stasi St. Petrus 
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/st_stefanus') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/stefanus/data_inventaris_stefanus">
                        Stasi St. Stefanus
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/st_mikael') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/mikael/data_inventaris_mikael">
                        Stasi St. Mikael
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_inventaris/st_paulus_merambai') ? 'active' : ''; ?>" 
                        href="index_pimpinan.php?page_pimpinan=data_inventaris/paulus_rasul/data_inventaris_paulus_rasul">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" id="transaksiDropdownMenu">
                        <a class="dropdown-item <?php echo ($halaman == 'data_transaksi/peminjaman/data_peminjaman') ? 'active' : ''; ?>" 
                           href="index_pimpinan.php?page_pimpinan=data_transaksi/peminjaman/data_peminjaman">
                           Peminjaman
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_transaksi/data_pengembalian') ? 'active' : ''; ?>" 
                           href="index_pimpinan.php?page_pimpinan=data_transaksi/pengembalian/data_pengembalian">
                           Pengembalian
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_transaksi/data_kerusakan') ? 'active' : ''; ?>" 
                           href="index_pimpinan.php?page_pimpinan=data_transaksi/kerusakan/data_kerusakan">
                           Kerusakan
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_transaksi/data_perbaikan') ? 'active' : ''; ?>" 
                           href="index_pimpinan.php?page_pimpinan=data_transaksi/perbaikan/data_perbaikan">
                           Perbaikan
                        </a>
                        <a class="dropdown-item <?php echo ($halaman == 'data_transaksi/data_mutasi') ? 'active' : ''; ?>" 
                           href="index_pimpinan.php?page_pimpinan=data_transaksi/mutasi/data_mutasi">
                           Mutasi
                        </a>
                    </div>
                </li>
        ...
        <div class="user-popup" id="userPopup">
            ...
            <div class="user-popup-links">
                <a href="index_pimpinan.php?page_pimpinan=profil/edit_profil">
    ...
    <div id="content">
        <div class="container">
            <?php
            if ($halaman == "") {
                include "page_pimpinan/dashboard.php";
            } else if (file_exists("page_pimpinan/$halaman.php")) {
                include "page_pimpinan/$halaman.php";
            } else {
                include "page_pimpinan/404.php";
            }
            ?>
        </div>
    </div>
