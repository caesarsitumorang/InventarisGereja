...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo "<script>
                ...
                window.location.href='index_stasi_fidelis.php?page_stasi_fidelis=data_transaksi/kerusakan/data_kerusakan';
              </script>";
    } else {
...
<div class="form-container">
    ...
    <div class="form-group half">
        ...
        <input type="text" name="lokasi_simpan" value="Stasi St. Fidelis (Karo Simalem)" readonly class="form-control">
    </div>
    <div class="form-group half">
        ...
        <select id="nama_barang" name="nama_barang" required class="form-control" onchange="updateDataBarang()">
            ...
            while ($row = mysqli_fetch_assoc($inventaris)) {
                if ($row['lokasi_simpan'] === "Stasi St. Fidelis (Karo Simalem)") {
            ...
            <div class="form-actions">
                ...
                <a href="index_stasi_fidelis.php?page_stasi_fidelis=data_transaksi/kerusakan/data_kerusakan" class="btn-cancel">Batal</a>
            </div>
        </form>
    </div>
</div>
