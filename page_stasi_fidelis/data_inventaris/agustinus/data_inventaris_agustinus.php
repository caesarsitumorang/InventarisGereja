...
if(isset($_POST['ajax'])) {
    ...
    <div class="table-scroll">
        <h1 style="text-align:center; margin-bottom: 15px;">Data Inventaris Stasi St. Agustinus (Minas Barat)</h1>
...
function loadData(page = 1) {
    ...
    fetch('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/agustinus/data_inventaris_agustinus', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/agustinus/cetak_inventaris_agustinus', '_blank');
}

function showAddForm() {
    window.location.href = 'index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/agustinus/tambah_inventaris_agustinus';
}
