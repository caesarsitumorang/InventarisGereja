...
if(isset($_POST['submit'])) {
    ...
    if(mysqli_stmt_execute($stmt)) {
        echo "<script>
                ...
                window.location.href='index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/agustinus/data_inventaris_agustinus';
              </script>";
    } else {
...
<div class="form-container">
    ...
    <input type="text" class="form-control" value="Stasi St. Agustinus (Minas Barat)" readonly>
    <input type="hidden" id="lokasi_simpan" name="lokasi_simpan" value="Stasi St. Agustinus (Minas Barat)">
</div>
            ...
            <div class="form-actions">
                ...
                <a href="index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/agustinus/data_inventaris_agustinus" class="btn-cancel">
