        ...
        <form method="POST" class="add-form ">
            <div class="form-row">
                <div class="form-group half">
                    ...
                    <input type="text" class="form-control" value="Stasi St. Fidelis (Karo Simalem)" readonly>
                    <input type="hidden" id="lokasi_simpan" name="lokasi_simpan" value="Stasi St. Fidelis (Karo Simalem)">
                </div>
