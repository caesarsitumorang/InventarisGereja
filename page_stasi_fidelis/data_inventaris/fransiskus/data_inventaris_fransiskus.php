...
function loadData(page = 1) {
    ...
    fetch('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/fransiskus/data_inventaris_fransiskus', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/fransiskus/cetak_inventaris_fransiskus', '_blank');
}

function showAddForm() {
    window.location.href = 'index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/fransiskus/tambah_inventaris_fransiskus';
}
