...
function loadData(page = 1) {
    ...
    fetch('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/paulus_rasul/data_inventaris_paulus_rasul', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/paulus_rasul/cetak_inventaris_paulus_rasul', '_blank');
}

function showAddForm() {
    window.location.href = 'index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/paulus_rasul/tambah_inventaris_paulus_rasul';
}
