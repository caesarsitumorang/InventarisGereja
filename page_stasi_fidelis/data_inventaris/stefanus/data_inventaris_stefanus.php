...
function loadData(page = 1) {
    ...
    fetch('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/stefanus/data_inventaris_stefanus', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/stefanus/cetak_inventaris_stefanus', '_blank');
}

function showAddForm() {
    window.location.href = 'index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/stefanus/tambah_inventaris_stefanus';
}
