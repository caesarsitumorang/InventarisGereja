...
function loadData(page = 1) {
    ...
    fetch('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/yohanes/data_inventaris_yohanes', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/yohanes/cetak_inventaris_yohanes', '_blank');
}

function showAddForm() {
    window.location.href = 'index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/yohanes/tambah_inventaris_yohanes';
}
