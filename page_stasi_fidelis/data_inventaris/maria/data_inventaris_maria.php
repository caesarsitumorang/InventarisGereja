...
function loadData(page = 1) {
    ...
    fetch('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/maria/data_inventaris_maria', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/maria/cetak_inventaris_maria', '_blank');
}

function showAddForm() {
    window.location.href = 'index_stasi_fidelis.php?page_stasi_fidelis=data_inventaris/maria/tambah_inventaris_maria';
}
