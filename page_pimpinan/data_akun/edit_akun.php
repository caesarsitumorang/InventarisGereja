...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            echo "<script>alert('Data berhasil diperbarui'); window.location='index_pimpinan.php?page_pimpinan=data_akun/data_akun';</script>";
            exit;
        } else {
    ...
    <div class="form-card">
        ...
        <form method="POST" enctype="multipart/form-data" class="add-form">
            ...
            <div class="form-actions">
                ...
                <a href="index_pimpinan.php?page_pimpinan=data_akun/data_akun">Batal</a>
            </div>
        </form>
    </div>
</div>
