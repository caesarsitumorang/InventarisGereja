    ...
    if ($row = mysqli_fetch_assoc($resultKerusakan)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            echo "<script>
                    ...
                    window.location.href='index_pimpinan.php?page_pimpinan=data_transaksi/perbaikan/data_perbaikan';
                  </script>";
        } else {
    ...
    <div class="form-card">
        ...
        <form method="POST" class="add-form">
            ...
            <div class="form-actions">
                ...
                <a href="index_pimpinan.php?page_pimpinan=data_transaksi/perbaikan/data_perbaikan" class="btn-cancel">Batal</a>
            </div>
        </form>
    </div>
</div>
