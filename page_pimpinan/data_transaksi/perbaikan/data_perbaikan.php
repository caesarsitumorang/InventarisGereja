...
function loadData(page = 1) {
    ...
    fetch('index_pimpinan.php?page_pimpinan=data_transaksi/perbaikan/data_perbaikan', {
        method: 'POST',
...
function downloadPDF(lokasi) {
    ...
    const url = 'index_pimpinan.php?page_pimpinan=data_transaksi/perbaikan/cetak_perbaikan&lokasi=' + 
...
function showAddForm() {
    window.location.href = 'index_pimpinan.php?page_pimpinan=data_transaksi/perbaikan/tambah_perbaikan';
}
