...
function loadData(page = 1) {
    ...
    fetch('index_pimpinan.php?page_pimpinan=data_transaksi/pengembalian/data_pengembalian', {
        method: 'POST',
...
function downloadPDF(lokasi) {
    ...
    const url = 'index_pimpinan.php?page_pimpinan=data_transaksi/pengembalian/cetak_pengembalian&lokasi=' + 
...
function showAddForm() {
    window.location.href = 'index_pimpinan.php?page_pimpinan=data_transaksi/pengembalian/tambah_pengembalian';
}
