...
function loadData(page = 1) {
    ...
    fetch('index_pimpinan.php?page_pimpinan=data_transaksi/peminjaman/data_peminjaman', {
        method: 'POST',
...
function downloadPDF(lokasi) {
    ...
    const url = 'index_pimpinan.php?page_pimpinan=data_transaksi/peminjaman/cetak_peminjaman&lokasi=' + 
...
function showAddForm() {
    window.location.href = 'index_pimpinan.php?page_pimpinan=data_transaksi/peminjaman/tambah_peminjaman';
}
