...
function loadData(page = 1) {
    ...
    fetch('index_pimpinan.php?page_pimpinan=data_transaksi/mutasi/data_mutasi', {
        method: 'POST',
...
function downloadPDF() {
    ...
    // Open PDF in new tab
    const url = 'index_pimpinan.php?page_pimpinan=data_transaksi/mutasi/cetak_mutasi' +
...
function showAddForm() {
    window.location.href = 'index_pimpinan.php?page_pimpinan=data_transaksi/mutasi/tambah_mutasi';
}
