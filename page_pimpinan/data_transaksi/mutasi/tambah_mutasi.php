...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo "<script>
                ...
                window.location.href='index_pimpinan.php?page_pimpinan=data_transaksi/mutasi/data_mutasi';
              </script>";
    } else {
    ...
    <div class="form-card">
        ...
        <form method="POST" class="add-form">
            ...
            <div class="form-actions">
                ...
                <a href="index_pimpinan.php?page_pimpinan=data_transaksi/mutasi/data_mutasi" class="btn-cancel">Batal</a>
            </div>
        </form>
    </div>
</div>
