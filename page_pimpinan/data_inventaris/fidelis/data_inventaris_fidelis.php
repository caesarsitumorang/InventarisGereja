...
if(isset($_POST['ajax'])) {
    ...
    $lokasi = "Stasi St. Fidelis (Karo Simalem)";

    // Hanya tarik data lokasi St. Fidelis
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <div class="action-buttons">
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/fidelis/edit_inventaris_fidelis&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/fidelis/edit_inventaris_fidelis&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_pimpinan.php?page_pimpinan=data_inventaris/fidelis/data_inventaris_fidelis', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_pimpinan.php?page_pimpinan=data_inventaris/fidelis/cetak_inventaris_fidelis', '_blank');
}

function showAddForm() {
    window.location.href = 'index_pimpinan.php?page_pimpinan=data_inventaris/fidelis/tambah_inventaris_fidelis';
}
