                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/paulus_empang/edit_inventaris_paulus_empang&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/paulus_empang/hapus_inventaris_paulus_empang&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_pimpinan.php?page_pimpinan=data_inventaris/paulus_empang/data_inventaris_paulus_empang', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_pimpinan.php?page_pimpinan=data_inventaris/paulus_empang/cetak_inventaris_paulus_empang', '_blank');
}

function showAddForm() {
    window.location.href = 'index_pimpinan.php?page_pimpinan=data_inventaris/paulus_empang/tambah_inventaris_paulus_empang';
}
