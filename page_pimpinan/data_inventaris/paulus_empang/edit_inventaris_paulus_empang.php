...
if(isset($_GET['id'])) {
    ...
    if(!$data) {
        echo "<script>
                ...
                window.location.href='index_pimpinan.php?page_pimpinan=data_inventaris/paulus_empang/data_inventaris_paulus_empang';
              </script>";
        exit;
    }
}
    ...
    <div class="form-card">
        ...
        <form method="POST" class="add-form" onsubmit="return validateForm()">
            ...
            <div class="form-actions">
                ...
                <a href="index_pimpinan.php?page_pimpinan=data_inventaris/paulus_empang/data_inventaris_paulus_empang" class="btn-cancel">
