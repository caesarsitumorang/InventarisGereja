                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/yohanes/edit_inventaris_yohanes&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/yohanes/hapus_inventaris_yohanes&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
