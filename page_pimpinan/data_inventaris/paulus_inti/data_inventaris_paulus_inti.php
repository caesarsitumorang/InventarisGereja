                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/paulus_inti/edit_inventaris_paulus_inti&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/paulus_inti/hapus_inventaris_paulus_inti&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_pimpinan.php?page_pimpinan=data_inventaris/paulus_inti/data_inventaris_paulus_inti', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_pimpinan.php?page_pimpinan=data_inventaris/paulus_inti/cetak_inventaris_paulus_inti', '_blank');
}

function showAddForm() {
    window.location.href = 'index_pimpinan.php?page_pimpinan=data_inventaris/paulus_inti/tambah_inventaris_paulus_inti';
}
