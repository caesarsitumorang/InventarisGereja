                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/agustinus/edit_inventaris_agustinus&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/agustinus/hapus_inventaris_agustinus&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_pimpinan.php?page_pimpinan=data_inventaris/agustinus/data_inventaris_agustinus', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_pimpinan.php?page_pimpinan=data_inventaris/agustinus/cetak_inventaris_agustinus', '_blank');
}

function showAddForm() {
    window.location.href = 'index_pimpinan.php?page_pimpinan=data_inventaris/agustinus/tambah_inventaris_agustinus';
}
