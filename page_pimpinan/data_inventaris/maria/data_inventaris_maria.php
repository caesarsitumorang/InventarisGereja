                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/maria/edit_inventaris_maria&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_pimpinan.php?page_pimpinan=data_inventaris/maria/hapus_inventaris_maria&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_pimpinan.php?page_pimpinan=data_inventaris/maria/data_inventaris_maria', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_pimpinan.php?page_pimpinan=data_inventaris/maria/cetak_inventaris_maria', '_blank');
}

function showAddForm() {
    window.location.href = 'index_pimpinan.php?page_pimpinan=data_inventaris/maria/tambah_inventaris_maria';
}
