...
function loadData(page = 1) {
    ...
    fetch('index_admin.php?page_admin=data_transaksi/pengembalian/data_pengembalian', {
        method: 'POST',
...
function downloadPDF(lokasi) {
    ...
    const url = 'index_admin.php?page_admin=data_transaksi/pengembalian/cetak_pengembalian&lokasi=' + 
...
function showAddForm() {
    window.location.href = 'index_admin.php?page_admin=data_transaksi/pengembalian/tambah_pengembalian';
}
