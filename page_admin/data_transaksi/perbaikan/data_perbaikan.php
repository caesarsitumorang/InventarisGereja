...
function loadData(page = 1) {
    ...
    fetch('index_admin.php?page_admin=data_transaksi/perbaikan/data_perbaikan', {
        method: 'POST',
...
function downloadPDF(lokasi) {
    ...
    const url = 'index_admin.php?page_admin=data_transaksi/perbaikan/cetak_perbaikan&lokasi=' + 
...
function showAddForm() {
    window.location.href = 'index_admin.php?page_admin=data_transaksi/perbaikan/tambah_perbaikan';
}
