...
function loadData(page = 1) {
    ...
    fetch('index_admin.php?page_admin=data_transaksi/kerusakan/data_kerusakan', {
        method: 'POST',
...
function downloadPDF(lokasi) {
    ...
    const url = 'index_admin.php?page_admin=data_transaksi/kerusakan/cetak_kerusakan&lokasi=' + 
...
function showAddForm() {
    window.location.href = 'index_admin.php?page_admin=data_transaksi/kerusakan/tambah_kerusakan';
}
