...
function loadData(page = 1) {
    ...
    fetch('index_admin.php?page_admin=data_transaksi/peminjaman/data_peminjaman', {
        method: 'POST',
...
function downloadPDF(lokasi) {
    ...
    const url = 'index_admin.php?page_admin=data_transaksi/peminjaman/cetak_peminjaman&lokasi=' + 
...
function showAddForm() {
    window.location.href = 'index_admin.php?page_admin=data_transaksi/peminjaman/tambah_peminjaman';
}
