                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_admin.php?page_admin=data_inventaris/benediktus/edit_inventaris_benediktus&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_admin.php?page_admin=data_inventaris/benediktus/hapus_inventaris_benediktus&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin.php?page_admin=data_inventaris/benediktus/data_inventaris_benediktus', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin.php?page_admin=data_inventaris/benediktus/cetak_inventaris_benediktus', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin.php?page_admin=data_inventaris/benediktus/tambah_inventaris_benediktus';
}
