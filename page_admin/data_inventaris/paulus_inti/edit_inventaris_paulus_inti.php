...
if(isset($_GET['id'])) {
    ...
    if(!$data) {
        echo "<script>
                ...
                window.location.href='index_admin.php?page_admin=data_inventaris/paulus_inti/data_inventaris_paulus_inti';
              </script>";
        exit;
    }
}
    ...
    <div class="form-card">
        ...
        <form method="POST" class="add-form" onsubmit="return validateForm()">
            ...
            <div class="form-actions">
                ...
                <a href="index_admin.php?page_admin=data_inventaris/paulus_inti/data_inventaris_paulus_inti" class="btn-cancel">
