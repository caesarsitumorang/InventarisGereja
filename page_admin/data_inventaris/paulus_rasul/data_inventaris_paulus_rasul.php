                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_admin.php?page_admin=data_inventaris/paulus_rasul/edit_inventaris_paulus_rasul&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_admin.php?page_admin=data_inventaris/paulus_rasul/hapus_inventaris_paulus_rasul&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin.php?page_admin=data_inventaris/paulus_rasul/data_inventaris_paulus_rasul', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin.php?page_admin=data_inventaris/paulus_rasul/cetak_inventaris_paulus_rasul', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin.php?page_admin=data_inventaris/paulus_rasul/tambah_inventaris_paulus_rasul';
}
