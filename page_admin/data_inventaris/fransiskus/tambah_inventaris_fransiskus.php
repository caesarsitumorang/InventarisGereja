...
if(isset($_POST['submit'])) {
    ...
    if(mysqli_stmt_execute($stmt)) {
        echo "<script>
                ...
                window.location.href='index_admin.php?page_admin=data_inventaris/fransiskus/data_inventaris_fransiskus';
              </script>";
    } else {
    ...
    <div class="form-card">
        ...
        <form method="POST" class="add-form ">
            ...
            <div class="form-actions">
                ...
                <a href="index_admin.php?page_admin=data_inventaris/fransiskus/data_inventaris_fransiskus" class="btn-cancel">
