            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <div class="action-buttons">
                            <a href="index_admin.php?page_admin=data_inventaris/fidelis/edit_inventaris_fidelis&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_admin.php?page_admin=data_inventaris/fidelis/edit_inventaris_fidelis&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin.php?page_admin=data_inventaris/fidelis/data_inventaris_fidelis', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin.php?page_admin=data_inventaris/fidelis/cetak_inventaris_fidelis', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin.php?page_admin=data_inventaris/fidelis/tambah_inventaris_fidelis';
}
