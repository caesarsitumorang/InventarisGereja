                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            <a href="index_admin.php?page_admin=data_inventaris/stefanus/hapus_inventaris_stefanus&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin.php?page_admin=data_inventaris/stefanus/data_inventaris_stefanus', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin.php?page_admin=data_inventaris/stefanus/cetak_inventaris_stefanus', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin.php?page_admin=data_inventaris/stefanus/tambah_inventaris_stefanus';
}
