...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO minuman (nama, deskripsi, harga, kategori, stok, gambar)
              VALUES ('$nama', '$deskripsi', '$harga', '$kategori', '$stok', '$gambar_name')";
    
    $insert = mysqli_query($koneksi, $query);

    if ($insert) {
        echo "<script>alert('Minuman berhasil ditambahkan!'); window.location='index_admin.php?page_admin=minuman/data_minuman';</script>";
    } else {
        echo "<script>alert('Gagal menambahkan minuman!');</script>";
    }
}
?>
