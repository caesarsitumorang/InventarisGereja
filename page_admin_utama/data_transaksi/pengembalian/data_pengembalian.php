...
while ($row_lokasi = mysqli_fetch_assoc($lokasi_query)) {
    $lokasi_list[] = $row_lokasi['nama_lokasi'];
}
...
if (isset($_POST['ajax'])) {
    ...
    $lokasi_filter = isset($_POST['lokasi_filter']) ? trim($_POST['lokasi_filter']) : (count($lokasi_list) > 0 ? $lokasi_list[0] : '');
    ...
    <div class="table-scroll">
        <h3 style="text-align:center; margin-bottom:15px;">
            Data Pengembalian <?= !empty($lokasi_filter) ? "- " . htmlspecialchars($lokasi_filter) : "" ?>
        </h3>
...
function loadData(page = 1) {
    ...
    fetch('index_admin_utama.php?page_admin_utama=data_transaksi/pengembalian/data_pengembalian', {
        method: 'POST',
...
function downloadPDF(lokasi) {
    ...
    const url = 'index_admin_utama.php?page_admin_utama=data_transaksi/pengembalian/cetak_pengembalian&lokasi=' + 
...
function showAddForm() {
    window.location.href = 'index_admin_utama.php?page_admin_utama=data_transaksi/pengembalian/tambah_pengembalian';
}
