...
if (isset($_POST['ajax'])) {
    ...
    <div class="table-scroll">
        ...
        <h3 style="text-align:center; margin-bottom:15px;">
            Data Kerusakan <?= !empty($lokasi_filter) ? "- " . htmlspecialchars($lokasi_filter) : "" ?>
        </h3>
...
<div id="locationModal" class="modal">
    <div class="modal-content location-modal">
        <div class="modal-header">
            <h3>Download Laporan Kerusakan</h3>
...
function loadData(page = 1) {
    ...
    fetch('index_admin_utama.php?page_admin_utama=data_transaksi/kerusakan/data_kerusakan', {
        method: 'POST',
...
function downloadPDF(lokasi) {
    ...
    const url = 'index_admin_utama.php?page_admin_utama=data_transaksi/kerusakan/cetak_kerusakan&lokasi=' + 
...
function showAddForm() {
    window.location.href = 'index_admin_utama.php?page_admin_utama=data_transaksi/kerusakan/tambah_kerusakan';
}
