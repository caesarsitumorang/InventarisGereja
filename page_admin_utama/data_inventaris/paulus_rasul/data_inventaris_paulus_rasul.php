...
if(isset($_POST['ajax'])) {
    ...
    <div class="table-scroll">
         <h1 style="text-align:center; margin-bottom: 15px;">Data Inventaris Stasi St. Paulus Rasul (Siak Merambai)</h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/paulus_rasul/edit_inventaris_paulus_rasul&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/paulus_rasul/hapus_inventaris_paulus_rasul&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin_utama.php?page_admin_utama=data_inventaris/paulus_rasul/data_inventaris_paulus_rasul', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin_utama.php?page_admin_utama=data_inventaris/paulus_rasul/cetak_inventaris_paulus_rasul', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin_utama.php?page_admin_utama=data_inventaris/paulus_rasul/tambah_inventaris_paulus_rasul';
}
