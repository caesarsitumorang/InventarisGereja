...
if(isset($_POST['ajax'])) {
    ...
    <div class="table-scroll">
        <h1 style="text-align:center; margin-bottom: 15px;">Data Inventaris Stasi St. Paulus (Inti 4)</h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/paulus_inti/edit_inventaris_paulus_inti&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/paulus_inti/hapus_inventaris_paulus_inti&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin_utama.php?page_admin_utama=data_inventaris/paulus_inti/data_inventaris_paulus_inti', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin_utama.php?page_admin_utama=data_inventaris/paulus_inti/cetak_inventaris_paulus_inti', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin_utama.php?page_admin_utama=data_inventaris/paulus_inti/tambah_inventaris_paulus_inti';
}
