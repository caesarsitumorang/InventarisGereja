...
if(isset($_POST['ajax'])) {
    ...
    <div class="table-scroll">
        <h1 style="text-align:center; margin-bottom: 15px;">Data Inventaris Stasi St. Stefanus (Zamrud)</h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/stefanus/edit_inventaris_stefanus&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/stefanus/hapus_inventaris_stefanus&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin_utama.php?page_admin_utama=data_inventaris/stefanus/data_inventaris_stefanus', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin_utama.php?page_admin_utama=data_inventaris/stefanus/cetak_inventaris_stefanus', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin_utama.php?page_admin_utama=data_inventaris/stefanus/tambah_inventaris_stefanus';
}
