...
if(isset($_POST['submit'])) {
    ...
    if(mysqli_stmt_execute($stmt)) {
        echo "<script>
                ...
                window.location.href='index_admin_utama.php?page_admin_utama=data_inventaris/stefanus/data_inventaris_stefanus';
              </script>";
    } else {
    ...
    <div class="form-card">
        ...
        <form method="POST" class="add-form ">
            ...
            <div class="form-actions">
                ...
                <a href="index_admin_utama.php?page_admin_utama=data_inventaris/stefanus/data_inventaris_stefanus" class="btn-cancel">
