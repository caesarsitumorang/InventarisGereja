                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/paroki/edit_inventaris_paroki&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/paroki/hapus_inventaris_paroki&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin_utama.php?page_admin_utama=data_inventaris/paroki/data_inventaris_paroki', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin_utama.php?page_admin_utama=data_inventaris/paroki/cetak_inventaris_paroki', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin_utama.php?page_admin_utama=data_inventaris/paroki/tambah_inventaris_paroki';
}
