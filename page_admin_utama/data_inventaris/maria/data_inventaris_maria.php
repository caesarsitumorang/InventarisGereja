...
if(isset($_POST['ajax'])) {
    ...
    $lokasi = "Stasi Sta. Maria Bunda Karmel (Teluk Merbau)";
    ...
    <div class="table-scroll">
        <h1 style="text-align:center; margin-bottom: 15px;">Data Inventaris Stasi Sta. Maria Bunda Karmel (Teluk Merbau)</h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/maria/edit_inventaris_maria&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/maria/hapus_inventaris_maria&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin_utama.php?page_admin_utama=data_inventaris/maria/data_inventaris_maria', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin_utama.php?page_admin_utama=data_inventaris/maria/cetak_inventaris_maria', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin_utama.php?page_admin_utama=data_inventaris/maria/tambah_inventaris_maria';
}
