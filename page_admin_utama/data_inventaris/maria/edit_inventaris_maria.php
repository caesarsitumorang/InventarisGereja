...
if(isset($_GET['id'])) {
    ...
    if(!$data) {
        echo "<script>
                ...
                window.location.href='index_admin_utama.php?page_admin_utama=data_inventaris/maria/data_inventaris_maria';
              </script>";
        exit;
    }
}
    ...
    <div class="form-card">
        ...
        <form method="POST" class="add-form" onsubmit="return validateForm()">
            ...
            <div class="form-actions">
                ...
                <a href="index_admin_utama.php?page_admin_utama=data_inventaris/maria/data_inventaris_maria" class="btn-cancel">
