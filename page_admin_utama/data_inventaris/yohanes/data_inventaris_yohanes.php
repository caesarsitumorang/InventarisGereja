...
if(isset($_POST['ajax'])) {
    ...
    <div class="table-scroll">
           <h1 style="text-align:center; margin-bottom: 15px;">Data Inventaris Stasi St. Yohanes Penginjil (Minas Jaya)</h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/yohanes/edit_inventaris_yohanes&id=<?= $row['id']; ?>" class="btn-edit">Edit</a>
                            <a href="index_admin_utama.php?page_admin_utama=data_inventaris/yohanes/hapus_inventaris_yohanes&id=<?= $row['id']; ?>" 
                            class="btn-delete" 
...
function loadData(page = 1) {
    ...
    fetch('index_admin_utama.php?page_admin_utama=data_inventaris/yohanes/data_inventaris_yohanes', {
        method: 'POST',
...
function downloadPDF() {
    window.open('index_admin_utama.php?page_admin_utama=data_inventaris/yohanes/cetak_inventaris_yohanes', '_blank');
}

function showAddForm() {
    window.location.href = 'index_admin_utama.php?page_admin_utama=data_inventaris/yohanes/tambah_inventaris_yohanes';
}
